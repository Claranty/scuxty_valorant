...
class Admin(commands.Cog):
    ...
    async def about(self, interaction: Interaction) -> None:
        ...
        owner_url = f'https://github.com/chllexandev'
        valorant_community = 'https://dsc.gg/valorantcom'
        invite_url = 'https://discord.com/oauth2/authorize?client_id=1028622043790450729&permissions=1103421104134&scope=bot%20applications.commands'

        embed = discord.Embed(color=0xFFFFFF)
        embed.set_author(name='VALORANT BOT', url=valorant_community)
        embed.set_thumbnail(url='https://i.imgur.com/bANdw1j.jpg')
        embed.add_field(name='DEV:', value=f"[ChlleXanDev#2006]({owner_url})", inline=False)
        embed.add_field(
            name='ᴄᴏɴᴛʀɪʙᴜᴛᴏʀꜱ:',
            value=f"[ꜱᴛᴀᴄɪᴀ.](https://github.com/staciax)\n"
        ...
        view = ui.View()
        view.add_item(ui.Button(label='GITHUB', url=owner_url, row=0))
        view.add_item(ui.Button(label='Valorant Community', url=valorant_community, row=0))
        view.add_item(ui.Button(label='Invite Bot', url=invite_url, row=0))
